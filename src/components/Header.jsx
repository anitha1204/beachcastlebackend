...
//             <h1 className='text-3xl sm:text-5xl md:text-6xl'>A Comfortable Resort Experience</h1>
//           </div>
...
//           <h1 className="text-xl sm:text-2xl md:text-7xl  text-primary mb-6">
  ...
  return (
   ...
   {/* <Facilities /> */}
      ...
      <div className="flex flex-wrap justify-center gap-6 lg:mt-10">
        ...
        {[[img1, "Lawn"], [img2, "Service Area"], [img3, "Covered Lawn"]].map(([image, title], index) => (
