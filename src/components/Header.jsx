      ...
      <section>
        <div className="flex flex-col items-center mt-4">
          <div className="relative flex-shrink-0 overflow-hidden">
            ...
            {/* Text Overlay */}
            <div className="absolute object-cover rounded-xl inset-0 flex flex-col h-[165px] ml-2 mt-2 items-center justify-center text-white bg-black bg-opacity-30 p-5 lg:w-[1435px] lg:h-[582px]">
              ...
              <button className="text-white text-center bg-black lg:py-3 lg:px-9 py-2 px-6 rounded-[50px] shadow-lg transition-transform duration-300 transform hover:scale-105 mt-4"
                onClick={() => {
                  contactRef.current?.scrollIntoView({
                    behavior: "smooth",
                  });
