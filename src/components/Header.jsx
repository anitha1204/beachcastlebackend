...
//             {/* Text Overlay */}
//             <div className="absolute object-cover rounded-xl inset-0 flex flex-col w-full h-[165px] ml-2 mt-2 items-center justify-center text-white bg-black bg-opacity-30  p-5 lg:w-[1435px] lg:h-[582px]">
...
//               Our Facilities
//             </h1>
//             <p className="text-sm md:text-md lg:text-lg mb-8 lg:mt-8 mt-2 text-gray-500">
