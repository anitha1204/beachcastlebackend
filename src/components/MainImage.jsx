      ...
      <section>
        <div className="flex flex-col items-center mt-4">
          <div className="relative flex-shrink-0 overflow-hidden">
            ...
            {/* Text Overlay */}
            <div className="absolute object-cover rounded-xl inset-0 flex flex-col lg:w-[1435px] lg:h-[582px] w-[370px] h-[585px] ml-2 mt-2 items-center justify-center text-white bg-black bg-opacity-40 p-5 lg:mt-2 lg:ml-2">
